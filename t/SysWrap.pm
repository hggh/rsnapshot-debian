...
sub rsnapshot {
	...
	return execute("/home/travis/perl5/perlbrew/perls/5.16/bin/perl /home/travis/build/rsnapshot/rsnapshot//rsnapshot $args >/dev/null 2>&1");
}

sub rsnapshot_output {
	my $args = shift(@_);
	return `/home/travis/perl5/perlbrew/perls/5.16/bin/perl /home/travis/build/rsnapshot/rsnapshot//rsnapshot $args`;
}
